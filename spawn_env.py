...
while True:
    ...
    qpos[0] =  0.08 #+ random.uniform(-1.70168, 1.70168)    # right_s0
    qpos[1] = -1.00 #+ random.uniform(-2.147, 1.047)        # right_s1
    qpos[2] =  1.19 #+ random.uniform(-3.05418, 3.05418)    # right_e0
    qpos[3] =  1.94 #+ random.uniform(-0.05, 2.618)         # right_e1
    qpos[4] = -0.67 #+ random.uniform(-3.059, 3.059)        # right_w0
    qpos[5] =  1.03 #+ random.uniform(-1.5708, 2.094)       # right_w1
    qpos[6] =  0.50 #+ random.uniform(-3.059, 3.059)        # right_w2
    qpos[7] =  0.02 #+ random.uniform(0, 0.020833)          # robotfinger_actuator_joint_r
